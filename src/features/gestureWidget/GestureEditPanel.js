...
import HiroSegment from './HiroSegment';
import BlossomSegment from './BlossomSegment';
...
export default function GestureEditPanel(props){
    ...
    return <React.Fragment>
            ...
            {currentGesture.points.map((point,k) => {
                if(props.robot === "blossom"){
                    return <BlossomSegment point={point} k={k} key={k} />
                }
                else{
                    return <HiroSegment point={point} k={k} key={k} />
                }
